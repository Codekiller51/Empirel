              ...
              {navLinks.map((link) => (
                <li key={link.path}>
                  <NavLink
                    to={link.path}
                    className={({ isActive }) =>
                      `text-white hover:text-primary-gold transition-colors font-medium text-xs lg:text-sm uppercase tracking-wider relative ${
                ...
                {navLinks.map((link) => (
                  <li key={link.path}>
                    <NavLink
                      to={link.path}
                      className={({ isActive }) =>
                        `text-white hover:text-primary-gold transition-colors font-medium text-lg ${
                          isActive ? 'text-primary-gold' : ''
                        }`
                      }
                    >
