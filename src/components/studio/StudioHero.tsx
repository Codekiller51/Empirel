    ...
    <div className="relative min-h-screen flex items-center bg-gradient-to-br from-purple-900 via-indigo-900 to-purple-800 dark:from-black dark:via-neutral-900 dark:to-purple-900 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(8)].map((_, i) => (
          ...
          >
            <div className="w-4 h-4 bg-purple-400/30 transform rotate-45" />
          </motion.div>
        ))}
      </div>
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <motion.div
              className="inline-flex items-center bg-purple-400/20 backdrop-blur-sm px-4 py-2 rounded-full text-purple-300 mb-6 md:mb-8"
          ...
          >
            ...
            {/* Decorative elements */}
            <div className="absolute -z-10 top-1/2 right-0 w-48 md:w-72 h-48 md:h-72 bg-purple-400/20 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2" />
            <div className="absolute -z-10 bottom-0 left-0 w-32 md:w-48 h-32 md:h-48 bg-indigo-500/20 rounded-full blur-2xl transform -translate-x-1/2" />
          </motion.div>
        </div>
      </div>
    </div>
